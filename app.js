...
const store = {
  ...
  questions: [
    {
      question: 'NBA franchise with most championships wins?',
      answers: [
        'Lakers',
        'Celtics',
        'Bucks',
    ...
    {
      question: 'Foreign City with NBA franchise?',
      answers: [
        'Toronto',
        'Moscow',
        'Abuja',
    ...
    {
      question: 'which NBA players wonn 11 times?',
      answers: [
        'Bird',
        'Johnson',
        'Russell',
    ...
    {
      question: 'Current NBA commissionner',
      answers: [
        'Stern',
        'Silver',
        'Ujiri',
...
function generateWelcomeString() {
  ...
  <div class="welcome">
    <form>
      <p>
        Hello Buddy. Lets check your NBA knowledge! Begin quiz by pressing the button.
      </p>
      
      <button type="submit"id="beginQuiz" autofocus>Start Quiz</button>
    </form>
  </div>
    `;
}
